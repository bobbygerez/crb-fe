    ...
    >
      <div style="padding: 30px">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-3">
            <q-input
              v-model="vendorable.rank "
              float-label="Prospect level"
              clearable
            />
          </div>
          <div class="col-xs-12 col-sm-3">
            <q-input
              v-model="vendorable.dis_percentage "
              float-label="Distribution Percentage"
              suffix="%"
              clearable
            />
          </div>
          ...
          <div class="col-xs-12 col-sm-4">
            <input-price
              label="Price/Package"
              :value="vendorablPrice"
              v-model="vendorablePrice"
            ></input-price>
          </div>
          <div class="col-xs-12 col-sm-4">
            <q-input
              v-model="vendorable.volume"
              float-label="Volume"
              clearable
            />
          </div>
      ...
      <div style="padding: 30px">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-6">
            <q-select
              v-model="vendorable.vendorable_type"
              :options="vendorableType"
          ...
          <div class="col-xs-12 col-sm-6">
            <q-search
              v-model="terms"
              :placeholder="placeholderVendorableType"
              float-label="Vendor Name"
            >
              <q-autocomplete
