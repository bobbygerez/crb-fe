...
<div>
    ...
    <q-modal v-model="newPurchaseRequestModal" minimized no-esc-dismiss no-backdrop-dismiss :content-css="{minWidth: '80vw', minHeight: '80vh'}">
        <div style="padding: 30px">
            ...
            <br />
            <q-table :data="purchasableItems" :columns="purchasableColumns" selection="multiple" :selected.sync="selectedSecond" row-key="label" color="secondary">
                <template slot="top-left" slot-scope="props">
                    <q-search hide-underline v-model="filterItem" />
                </template>
            </q-table>
            <br />
            <q-btn color="red" v-close-overlay label="Close" @click="hideModal()" />
