<template>
<div>
    <q-table ref="table" color="primary" title="All Accounting Standards" :data="serverData" :columns="columns" :filter="filter" row-key="name" :pagination.sync="serverPagination" :rows-per-page-options="options" @request="request" :loading="loading">
    ...
    <q-modal v-model="editAccountingStandardModal" minimized no-esc-dismiss no-backdrop-dismiss :content-css="{minWidth: '80vw', minHeight: '80vh'}">
        <div style="padding: 30px">
            <div class="q-display-1 q-mb-md">Edit {{ accountingStandard.name }}</div>
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <q-input v-model="accountingStandard.name" float-label="Name" clearable />
                </div>
                <div class="col-xs-12 col-sm-6">
                    <q-input v-model="accountingStandard.mask" float-label="Mask" clearable />
                </div>
            </div>
            <br />
    ...
    <q-modal v-model="newAccountingStandard" minimized no-esc-dismiss no-backdrop-dismiss :content-css="{minWidth: '80vw', minHeight: '80vh'}">
        <div style="padding: 30px">
            ...
            <br />
            <q-btn color="red" v-close-overlay label="Close" @click="hideModal()" />
            <q-btn color="primary" @click="store()" label="Create" class="q-ml-sm" />
