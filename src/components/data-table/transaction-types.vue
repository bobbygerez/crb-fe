...
<div>
    ...
    <q-modal v-model="newTransactionType" minimized no-esc-dismiss no-backdrop-dismiss :content-css="{minWidth: '80vw', minHeight: '80vh'}">
        <div style="padding: 30px">
            <div class="row">
                <div class="col-xs-12">
                    <div class="q-display-1 q-mb-md">New {{ transactionType.name }}</div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12">
                    ...
                    <q-tree :nodes="chartAccounts" color="secondary" :selected.sync="transactionType.chart_account_id" node-key="id" label-key="label">
...
export default {
    ...
    methods: {
        ...
        index() {
            ...
            this.$axios
                .get(`/modelable-chart-account?companyId=${this.$route.params.id}`)
                .then(res => {
