<template>
  <div class="q-pa-sm">
    <div class="row">
<<<<<<< HEAD:src/pages/dashboard/submenu/transactions/disbursement.vue
        <div class="col-xs-9">
...
>>>>>>> e935bbd434ba8a9050fe5c2aad69d70d42db8bbb:src/pages/dashboard/submenu/transactions/add.vue
            </div>
          </q-card-title>
          <q-card-main>
            <div class="row">
              ...
              <div class="col-xs-4">
                <q-select
                  v-model="selectedVendorableType"
                  filter
                  :options="entities"
              ...
              <div class="col-xs-4">
                <q-select
                  v-model="selectedVendorableName"
                  filter
