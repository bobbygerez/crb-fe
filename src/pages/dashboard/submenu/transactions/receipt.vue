            ...
            <q-card inline class="full-width">
                <q-card-title>
                    <div class="row">
                        ...
                        <div class="col-xs-2">
                            <q-input v-model="receiptTrans.reference" float-label="Reference" class="q-mr-sm" />
                        </div>
                        <div class="col-xs-2">
                ...
                <q-card-main>
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <q-select v-model="payor.payable_type" filter :options="entities" float-label="Customer Type" class="q-ml-sm" />
                        </div>
                        <div class="col-xs-3">
                            <q-select v-model="payor.payable_id" filter :options="vendorableNames" float-label="Customer Name" class="q-ml-sm" />
                        </div>
