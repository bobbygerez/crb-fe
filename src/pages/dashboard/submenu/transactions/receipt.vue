  ...
  <div class="q-pa-sm">
    ...
    <q-modal v-model="modalPurchaseReceived">
      <div style="padding: 20px">
        <div class="q-mb-md">Modal</div>
        <p>This one gets displayed from </p>
        <q-btn
          color="orange"
          @click="modalPurchaseReceived = false"
          label="Close"
        />
      </div>
    </q-modal>
          ...
          if (headChange != null) {
            Object.keys(vm1.additionalItems).forEach(function (key) {
              if (vm1.additionalItems[key].id === headChange.id) {
                ...
                vm1.additionalItems[key].chart_account_id =
                ...
                if (parseInt(headChange.qty) > 0) {
                  vm1.additionalItems[key].amount = parseFloat(
