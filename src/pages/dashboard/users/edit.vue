    ...
    <div class="row">
      ...
      <div class="col-4">
        <q-input
          ...
          :error="!$v.editUser.username.required"
          label="Username"
          class="q-ma-sm"
        />
      </div>
      <div class="col-4">
        <q-input
          ...
          label="Email"
          class="q-ma-sm"
          :error="!$v.editUser.email.required || !$v.editUser.email.email"
        />
      </div>
      <div class="col-4">
        <q-input
          outlined
          v-model="$v.editUser.information.mobile.$model"
          bottom-slots
          error-message="Mobile must be 11 digits and required."
          label="Mobile"
          class="q-ma-sm"
          :error="!$v.editUser.information.mobile.required || !$v.editUser.information.mobile.integer|| !$v.editUser.information.mobile.minLength"
        />
      </div>
      <div class="col-4">
        <q-input
          outlined
          v-model="$v.editUser.firstname.$model"
          bottom-slots
          error-message="Firstname is required."
          label="Firstname"
          class="q-ma-sm"
          :error="!$v.editUser.firstname.required"
        />
      </div>
      <div class="col-4">
        <q-input
          outlined
          v-model="$v.editUser.middlename.$model"
          bottom-slots
          error-message="Middlename is required."
          label="Middlename"
          class="q-ma-sm"
          :error="!$v.editUser.middlename.required"
        />
      </div>
      <div class="col-4">
        <q-input
          outlined
          v-model="$v.editUser.lastname.$model"
          bottom-slots
          error-message="Lastname is required."
          label="Lastname"
          class="q-ma-sm"
          :error="!$v.editUser.lastname.required"
        />
      </div>
      <div class="col-12">
        <q-select
      ...
      <div class="col-4">
        <q-select
          ...
          use-chips
          emit-value
          :error="!$v.selectedProvince.places"
          bottom-slots
      ...
      <div class="col-4">
        <q-select
          outlined
          v-model="$v.selectedBrgy.$model"
          :options="editBrgys"
          label="Brgys"
          class="q-ma-sm"
          use-chips
          emit-value
          :error="!$v.selectedBrgy.places"
          bottom-slots
      ...
      <div class="col-12">
        <q-input
          type="textarea"
          outlined
          v-model="$v.editUser.address.street_lot_blk.$model"
          label="Blk, Lot and Street No."
          class="q-ma-sm"
          :error="!$v.editUser.address.street_lot_blk.required"
          bottom-slots
