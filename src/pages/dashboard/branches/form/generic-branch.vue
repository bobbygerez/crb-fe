...
<div class="q-ma-md">
    <div class="row">
        ...
        <div class="col-6">
            <q-input outlined v-model="$v.childBranch.name.$model" label="Name" class="q-ma-sm" :error="$v.childBranch.name.$dirty&& !$v.childBranch.name.required" bottom-slots error-message="Branch name is required." />
        </div>
        <div class="col-6">
