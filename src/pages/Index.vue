...
<q-page class="docs-input row main">
    <div class="formContainer self-center col-12 offset-sm-2 col-sm-8 offset-md-3 col-md-6 ">
        <form @submit.prevent="submit">
            ...
            <q-input  v-model="$v.email.$model" label="Username/Email" dark @keyup.enter="login" />
            <q-input v-model="$v.password.$model" :type="isPwd ? 'password' : 'text'" dark class="q-mt-sm form__input" label="Password" @keyup.enter="login">
